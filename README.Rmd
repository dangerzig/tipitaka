...
The goal of tipitaka is to allow students and reserachers to apply the tools of computational linguistics to the ancient Buddhist texts known as the Tipitaka or Pali Canon. 

The Tipitaka is the canonical scripture of Theravadin Buddhists worldside. It purports to record the direct teachings of the historical Buddha. It was first recorded in written form in what is now Sri Lanka, likely around 100 BCE.
...
```{r kmeans, echo=FALSE, message=FALSE}
...
```{r wordclouds, echo=FALSE, message=FALSE}
library(wordcloud)
library(dplyr)
sati_sutta_long %>%
