...
For a **lemmatized critical edition** of the Tipitaka with sutta-level granularity, see [tipitaka.critical](https://github.com/dangerzig/tipitaka.critical).
...
* `tipitaka_long` — Word frequencies per volume (computed on first access)
