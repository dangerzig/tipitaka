...
For a **lemmatized critical edition** of the Tipitaka with sutta-level granularity, see the companion package [tipitaka.critical](https://github.com/dangerzig/tipitaka.critical). It provides:

* Lemmatization using the Digital Pali Dictionary (98% coverage)
* Full text for ~5,800 individual text units across all three pitakas
* Sutta-level word frequency data and sparse document-term matrices
* Based on a five-witness collation (PTS, SuttaCentral, VRI, BJT, Thai)

## Data Sources

This package includes the complete Tipitaka from the Chattha Sangayana Tipitaka version 4.0 (CST4) published by the Vipassana Research Institute. It covers all three pitakas (Vinaya, Sutta, and Abhidhamma).

* `tipitaka_raw` — Full text per volume
